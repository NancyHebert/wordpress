		...
		<div class="container">
			<div class="row">
					...
					<div class="page_title">
						<h2><?php 
							if( class_exists( 'WooCommerce' ) && is_shop() ) :
								$shop_text = get_theme_mod('shop_prefix',__('Shop','aneeq'));
								printf( __( '%1$s %2$s', 'aneeq' ), $shop_text, single_tag_title( '', false ));
							elseif( is_product() ): 
								the_title( '<h2>', '</h2>' ); 
							endif; ?>
						</h2>
				...
				<div class="col-md-4 col-sm-6 col-xs-12">
					<nav id="breadcrumbs">
						<ul>
							<li><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php _e('Home', 'aneeq'); ?></a>/</li>
							<li><?php 
								if( class_exists( 'WooCommerce' ) && is_shop() ) :
									$shop_text = get_theme_mod('shop_prefix',__('Shop','aneeq'));
									printf( __( '%1$s %2$s', 'aneeq' ), $shop_text, single_tag_title( '', false ));
