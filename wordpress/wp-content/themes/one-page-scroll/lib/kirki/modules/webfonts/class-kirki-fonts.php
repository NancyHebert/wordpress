...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'one-page-scroll' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'one-page-scroll' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'one-page-scroll' ),
			'200'       => esc_attr__( 'Light 200', 'one-page-scroll' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'one-page-scroll' ),
			'300'       => esc_attr__( 'Book 300', 'one-page-scroll' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'one-page-scroll' ),
			'400'       => esc_attr__( 'Normal 400', 'one-page-scroll' ),
			'regular'   => esc_attr__( 'Normal 400', 'one-page-scroll' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'one-page-scroll' ),
			'500'       => esc_attr__( 'Medium 500', 'one-page-scroll' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'one-page-scroll' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'one-page-scroll' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'one-page-scroll' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'one-page-scroll' ),
			'700'       => esc_attr__( 'Bold 700', 'one-page-scroll' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'one-page-scroll' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'one-page-scroll' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'one-page-scroll' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'one-page-scroll' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'one-page-scroll' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'one-page-scroll' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'one-page-scroll' ),
		);
	}
