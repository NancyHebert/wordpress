...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'one-page-scroll' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'one-page-scroll' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'one-page-scroll' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'one-page-scroll' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'one-page-scroll' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'one-page-scroll' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'one-page-scroll' ); ?>',
		} );
		#>
		<label>
