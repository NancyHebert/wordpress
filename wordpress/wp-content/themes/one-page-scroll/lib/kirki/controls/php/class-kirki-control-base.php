	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'one-page-scroll' ),
				'remove'               => esc_attr__( 'Remove', 'one-page-scroll' ),
				'default'              => esc_attr__( 'Default', 'one-page-scroll' ),
				'selectFile'           => esc_attr__( 'Select File', 'one-page-scroll' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'one-page-scroll' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'one-page-scroll' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'one-page-scroll' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'one-page-scroll' ),
			)
		);
