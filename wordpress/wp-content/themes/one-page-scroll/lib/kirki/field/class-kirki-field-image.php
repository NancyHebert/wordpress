...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'one-page-scroll' ),
				'change'       => esc_attr__( 'Change image', 'one-page-scroll' ),
				'default'      => esc_attr__( 'Default', 'one-page-scroll' ),
				'remove'       => esc_attr__( 'Remove', 'one-page-scroll' ),
				'placeholder'  => esc_attr__( 'No image selected', 'one-page-scroll' ),
				'frame_title'  => esc_attr__( 'Select image', 'one-page-scroll' ),
				'frame_button' => esc_attr__( 'Choose image', 'one-page-scroll' ),
			)
		);
	}
