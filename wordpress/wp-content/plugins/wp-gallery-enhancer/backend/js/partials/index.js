	...
	return class extends Component {
		...
		initGalleryStyling() {
			...
			this.initTimeOut = setTimeout( () => {
				...
				const gallery = wrapper.querySelector('.wp-block-gallery:not(.block-editor-media-placeholder)');
		...
		isWpge(gallery) {
			...
			const wpge = wpgeClasses.filter(selector => gallery.classList.contains(selector) );
